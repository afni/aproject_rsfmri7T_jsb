...
if ( $use_slurm ) then
    ...
    # when the time here was only 5min, a few subjects didn't quiiite 
    # finish, and so the data copy wasn't complete, creating a problem;
    # therefore, have extended to the very safe 15min
    swarm                                                          \
        -f ${scr_swarm}                                            \
